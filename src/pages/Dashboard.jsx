...
export default function Dashboard() {
  ...
  if (latest) {
    if (displayRate >= target) {
      ...
      insightText = `💡 ${profile.name || 'User'}, try to reach your ${target}% savings goal.`;
    }
  }
